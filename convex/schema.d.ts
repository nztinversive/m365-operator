declare const _default: import("convex/server").SchemaDefinition<{
    ...
    messages: import("convex/server").TableDefinition<import("convex/values").VObject<{
        ...
        createdAt: import("convex/values").VFloat64<number, "required">;
    }, "required", "content" | "role" | "createdAt" | "userId" | "conversationId" | "jobId">, {
        by_userId: ["userId", "_creationTime"];
    ...
    }, "required", "type" | "error" | "createdAt" | "userId" | "updatedAt" | "conversationId" | "status" | "input" | "output" | "progress" | "progressMessage" | "completedAt" | `input.${string}` | `output.${string}`>, {
        by_userId: ["userId", "_creationTime"];
    ...
    documents: import("convex/server").TableDefinition<import("convex/values").VObject<{
        ...
        createdAt: import("convex/values").VFloat64<number, "required">;
    }, "required", "name" | "size" | "type" | "createdAt" | "userId" | "jobId" | "driveItemId" | "webUrl">, {
        by_userId: ["userId", "_creationTime"];
        by_jobId: ["jobId", "_creationTime"];
    }, {}, {}>;
