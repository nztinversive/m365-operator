...
export function ChatView({ account, onLogout, userId }: ChatViewProps) {
  ...
  // Auto-select or create conversation on first load
  useEffect(() => {
  ...
  return (
    <div className="flex h-screen bg-gray-950">
      ...
      <div
        ...
        } flex-shrink-0 overflow-hidden border-r border-gray-800 bg-gray-900/80 transition-all duration-200`}
      >
        ...
        <div className="flex-1 space-y-4 overflow-y-auto px-4 py-4">
          ...
          {(isSubmitting || activeJob) && (
            <div className="flex gap-3">
              ...
              <div className="animate-pulse rounded-xl bg-gray-800 px-4 py-2.5 text-sm text-gray-300">
